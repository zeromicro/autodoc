				...
				// ── 3. Guides (was Tutorials) ────────────────────────────
				{
					...
					items: [
						{ slug: 'guides' },
						{
							...
							collapsed: true,
							items: [{ autogenerate: { directory: 'guides/quickstart' } }],
						},
						{
							label: 'HTTP Service',
							translations: { 'zh-CN': 'HTTP 服务', ko: 'HTTP 서비스' },
							collapsed: true,
							items: [{ autogenerate: { directory: 'guides/http' } }],
						},
						{
							label: 'gRPC Service',
							translations: { 'zh-CN': 'gRPC 服务', ko: 'gRPC 서비스' },
							collapsed: true,
							items: [{ autogenerate: { directory: 'guides/grpc' } }],
						},
						{
							label: 'Database',
						...
						},
						{
							...
							collapsed: true,
							items: [{ autogenerate: { directory: 'guides/microservice' } }],
						},
						{
							label: 'Message Queue',
							translations: { 'zh-CN': '消息队列', ko: '메시지 큐' },
							collapsed: true,
							items: [{ autogenerate: { directory: 'guides/queue' } }],
						},
						{
							label: 'API Gateway',
							translations: { 'zh-CN': 'API 网关', ko: 'API 게이트웨이' },
							collapsed: true,
							items: [{ autogenerate: { directory: 'guides/gateway' } }],
						},
						{
							label: 'Deployment',
						...
						},
						{
							...
							collapsed: true,
							items: [{ autogenerate: { directory: 'guides/cron-job' } }],
						},
						{
				...
				// ── 4. Components ────────────────────────────────────────
				{
					...
					items: [
						{ slug: 'components' },
						{
							...
							collapsed: true,
							items: [{ autogenerate: { directory: 'components/cache' } }],
						},
						{
							label: 'Resilience',
							translations: { 'zh-CN': '服务韧性', ko: '탄력성' },
							collapsed: true,
							items: [{ autogenerate: { directory: 'components/resilience' } }],
						},
						{
							label: 'Concurrency',
							translations: { 'zh-CN': '并发工具', ko: '동시성 도구' },
							collapsed: true,
							items: [{ autogenerate: { directory: 'components/concurrency' } }],
						},
						{
							label: 'Log',
							translations: { 'zh-CN': '日志', ko: '로그' },
							collapsed: true,
							items: [{ autogenerate: { directory: 'components/log' } }],
						},
						{
							label: 'Observability',
							translations: { 'zh-CN': '可观测性', ko: '관측 가능성' },
							collapsed: true,
							items: [{ autogenerate: { directory: 'components/observability' } }],
						},
						{
							label: 'Queue',
							translations: { 'zh-CN': '队列', ko: '큐' },
							collapsed: true,
							items: [{ autogenerate: { directory: 'components/queue' } }],
						},
					],
				},
				// ── 5. Reference ─────────────────────────────────────────
				{
					...
					items: [
						{ slug: 'reference' },
						{
							...
							collapsed: true,
							items: [{ autogenerate: { directory: 'reference/api-dsl' } }],
						},
						{
							label: 'Proto DSL',
							translations: { 'zh-CN': 'Proto DSL', ko: 'Proto DSL' },
							collapsed: true,
							items: [{ autogenerate: { directory: 'reference/proto-dsl' } }],
						},
						{
							label: 'goctl CLI',
							translations: { 'zh-CN': 'goctl 命令', ko: 'goctl 명령어' },
							collapsed: true,
							items: [{ autogenerate: { directory: 'reference/cli-guide' } }],
						},
						{
							label: 'Configuration',
							translations: { 'zh-CN': '配置', ko: '설정' },
							collapsed: true,
							items: [{ autogenerate: { directory: 'reference/configuration' } }],
						},
						{
							label: 'Customization',
							translations: { 'zh-CN': '模板定制', ko: '템플릿 커스터마이징' },
							collapsed: true,
							items: [{ autogenerate: { directory: 'reference/customization' } }],
						},
						...
						{ slug: 'reference/changelog' },
						{
							...
							collapsed: true,
							items: [{ autogenerate: { directory: 'reference/releases' } }],
						},
					],
				},
				// ── 6. Community (FAQ + Contributing + Examples) ─────────
				{
					...
					items: [
						...
						{ slug: 'community/contributors' },
						{
							...
							collapsed: true,
							items: [{ autogenerate: { directory: 'community/faq' } }],
						},
						{
							label: 'Examples',
