---
title: MySQL CRUD
description: Perform CRUD operations with MySQL in go-zero.
sidebar:
  order: 3
...
We can get a sqlx.SqlConn at [to create a link](./connection) and then we can complete various database operations. We strongly recommend using [goctl model](../cli/model) to generate sql code automatically, without manual entry.
