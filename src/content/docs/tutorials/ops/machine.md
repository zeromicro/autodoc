...
description: Deploy go-zero services to a physical or virtual machine.
sidebar:
  order: 3
...
![deploy-server-jenkins-pipline](/resource/tutorials/ops/deploy-server-jenkins-pipline.jpg)

Then click on “General”, select "This project is parameterized", "Add parameter", "Choice Parameter", like the beacon

![deploy-server-plpline-2](/resource/tutorials/ops/deploy-server-plpline-2.png)

Then write the following

![deploy-server-pipline-3](/resource/tutorials/ops/deploy-server-pipline-3.png)
...
![deploy-server-deploy](/resource/tutorials/ops/deploy-server-deploy.jpg)

Tap Build with Parameters, select the corresponding "branch" to "Service" to start building

![deploy-server-deploy-2](/resource/tutorials/ops/deploy-server-deploy-2.jpg)
