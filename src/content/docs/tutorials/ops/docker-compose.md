...
description: Deploy go-zero services with Docker Compose.
sidebar:
  order: 5
...
![gitlab-pz-jenkins-sshkey](/resource/tutorials/ops/gitlab-pz-jenkins-sshkey.jpg)

## 3. Mirror Repository

Go to harbor to create this project's mirror repository

![gitlab-pz-jenkins-sshkey](/resource/tutorials/ops/apicode-harbor_new.png)

![gitlab-pz-jenkins-sshkey](/resource/tutorials/ops/apicode-harbor2_new.png)

View the push command

![gitlab-pz-jenkins-sshkey](/resource/tutorials/ops/image-20220209191757422_newnew.png)
...
![gitlab-pz-jenkins-sshkey](/resource/tutorials/ops/apicode-docker.png)

Then click on “General”, select "This project is parameterized", "Add parameter", "Choice Parameter", like the beacon

![gitlab-pz-jenkins-sshkey](/resource/tutorials/ops/deploy-server-plpline-2.png)

Then write the following

![gitlab-pz-jenkins-sshkey](/resource/tutorials/ops/deploy-server-pipline-3.png)
...
![gitlab-pz-jenkins-sshkey](/resource/tutorials/ops/deploy-server-deploy.jpg)

Tap Build with Parameters, select the corresponding "branch" to "Service" to start building

![gitlab-pz-jenkins-sshkey](/resource/tutorials/ops/deploy-server-deploy-2.jpg)
