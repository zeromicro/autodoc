...
Detailed 릴리스 노트 위한 모든 go-zero version은 available 에서 [릴리스 노트](../releases/) section입니다.

위한 전체 history see [GitHub 릴리스 page](https://github.com/zeromicro/go-zero/releases).
...
| [v1.9.1](../releases/v1.9.1) | 2025-10-02 |해당 항목의 동작과 사용법을 설명합니다. |
