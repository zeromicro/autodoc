...
description: Connect to Redis and run commands in go-zero.
---
...
Initialize redis configuration, we recommend loading using conf.MustLoad for configurations, reference[configuration profiles](../static-configuration/configuration)
