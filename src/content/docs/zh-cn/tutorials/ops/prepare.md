---
title: 环境准备
description: 准备 CI/CD 环境（GitLab、Jenkins、Harbor、Kubernetes）。
sidebar:
  order: 2
...
![gitlab](/resource/tutorials/ops/image-20220209100353045.png)

账号默认是 root

### 2.3 创建项目 k8scode

![gitlab](/resource/tutorials/ops/image-20220209100813435.png)

### 2.4 配置 ssh 公钥

点击头像位置下箭头，“设置”

![gitlab](/resource/tutorials/ops/image-20220209101148261.png)

![gitlab](/resource/tutorials/ops/gitlab-ssh-key.png)
...
![gitlab](/resource/tutorials/ops/image-20220209134737504.png)

登陆成功

![gitlab](/resource/tutorials/ops/README.png)
...
![gitlab](/resource/tutorials/ops/image-20220209104638510.png)
...
![gitlab](/resource/tutorials/ops/image-20220209104946101.png)

选择“安装推荐插件“

![gitlab](/resource/tutorials/ops/image-20220209105921610.png)

然后等待插件安装完成

![gitlab](/resource/tutorials/ops/image-20220209110010562.png)
...
![gitlab](/resource/tutorials/ops/jenkins-user.png)

### 4.5 部署完成

![gitlab](/resource/tutorials/ops/image-20220209111135979.png)
...
![gitlab](/resource/tutorials/ops/image-20220209111325922.png)

点击 "Manage Credentials"

![gitlab](/resource/tutorials/ops/image-20220209111450217.png)

点击“全局”后面的三角标，然后在点击“添加凭据”

![gitlab](/resource/tutorials/ops/image-20220209111612564.png)
...
![gitlab](/resource/tutorials/ops/image-20220209112430241.png)
...
![gitlab](/resource/tutorials/ops/image-20220209112756140.png)

下滑动到`全局属性`条目，添加 docker 私有仓库相关信息，如图为`docker用户名`、`docker用户密码`、`docker私有仓库地址`

![gitlab](/resource/tutorials/ops/image-20220210095715913.png)
...
![gitlab](/resource/tutorials/ops/image-20220209195140145.png)

配置 pipline 需要的 Git Parameter 插件

点击 “系统配置” -> “插件管理”

![gitlab](/resource/tutorials/ops/image-20220209200922797.png)

然后点击“可选插件” , 搜索中输入 “Git Parameter” , 如下图

![gitlab](/resource/tutorials/ops/image-20220209201022699.png)
