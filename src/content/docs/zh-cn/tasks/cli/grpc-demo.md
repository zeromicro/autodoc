...
description: 使用 goctl 从 .proto 文件生成 gRPC 服务。
sidebar:
  order: 4
...
![task-grpc-demo-grpcui](/resource/tasks/cli/task-grpc-demo-grpcui.png)
...
**Postman 中访问**
![task-grpc-demo-grpcui](/resource/tasks/cli/task-grpc-demo-postman.png)
