---
title: 请求体
description: 在 go-zero HTTP 处理器中解析请求体。
sidebar:
  order: 5
...
关于参数区间的详细说明请参考 api 语法 <a href="/docs/reference/api-dsl/parameter" target="_blank">参数规则</a>
...
- <a href="/docs/reference/api-dsl/parameter" target="_blank">《api | HTTP 请求参数规则》</a>
