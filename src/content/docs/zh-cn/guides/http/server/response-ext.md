---
title: 响应扩展
description: go-zero HTTP 服务中的扩展响应助手。
sidebar:
  order: 7
...
:::tip 温馨提示
这一步，为了防止每次代码生成都要更改，可以通过修改模板来实现，自定义模板用法可参考 [《模板定制化》](/reference/customization/template)
:::
...
- [《goctl 代码生成工具使用》](/reference/cli-guide/)
- https://github.com/zeromicro/x
- [《模板定制化》](/reference/customization/template)
