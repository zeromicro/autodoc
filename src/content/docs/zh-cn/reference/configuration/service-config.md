---
title: 服务配置
description: go-zero 所有服务类型共享的基础服务配置。
sidebar:
  order: 5
...
| Prometheus | prometheus.Config | -      | 参考 [Prometheus](../../../components/observability/metrics) |
| Telemetry  | trace.Config      | -      | 参考 [链路追踪](../../../components/observability/tracing)                                                                        |
