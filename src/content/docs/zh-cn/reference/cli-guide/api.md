---
title: goctl API
description: 从 .api 文件生成 HTTP 服务代码。
sidebar:
  order: 4
...
| style                   | string                  | NO                      | `gozero`               | 输出文件和目录的命名风格格式化符号，详情见[文件风格](/reference/cli-guide/style) |
...
插件资源请参考 [goctl 插件资源](/reference/goctl-plugins)

### swagger

根据 api 文件生成 swagger 文档，详情可参考 [swagger 生成](/reference/cli-guide/swagger)
