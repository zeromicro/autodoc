---
title: goctl Model
description: Generate database model code with goctl.
sidebar:
  order: 6
...
Type mapping customization can only be used in the experimental version. For how to enable the experimental version, please refer to <a href="do../reference/cli-guide/env" target="_blank">goctl env</a>，For configuration use, please refer to <a href="do../reference/cli-guide/config" target="_blank">goctl config</a>
