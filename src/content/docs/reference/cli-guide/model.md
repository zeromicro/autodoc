...
| style                                                | string                                              | NO                                             | `gozero`                                           | Named style symbols for output files and directories, see [file style](./style.md)                                |
...
Type mapping customization can only be used in the experimental version. To enable the experimental version, see [goctl env](./env.md). For configuration use, see [goctl config](./config.md).
