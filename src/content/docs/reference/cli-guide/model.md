...
Type mapping customization can only be used in the experimental version. For how to enable the experimental version, please refer to <a href="../env" target="_blank">goctl env</a>，For configuration use, please refer to <a href="../config" target="_blank">goctl config</a>
