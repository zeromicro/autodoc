---
title: goctl API
description: Generate HTTP service code from an .api file.
sidebar:
  order: 4
...
Plugin resource reference: [goctl plugin resource](../../goctl-plugins.md)


### swagger

Generate swagger file from api file, for details please see [swagger generation](./swagger.md).
